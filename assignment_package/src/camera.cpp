...
Camera::Camera(unsigned int w, unsigned int h):
    Camera(w, h, glm::vec3(0,1,10), glm::vec3(0,0,0), glm::vec3(0,1,0))
{}
...
{
    glm::vec3 translation = glm::vec3(look.x, 0, look.z) * amt;
    eye += translation;
    ref += translation;
}
...
{
    glm::vec3 translation = glm::vec3(right.x, 0, right.z) * amt;
    eye += translation;
    ref += translation;
}
void Camera::TranslateAlongUp(float amt)
{
    glm::vec3 translation = glm::vec3(0, up.y, 0) * amt;
    eye += translation;
    ref += translation;
}
